...
const NAV_GROUPS = [
  {
    title: '浏览',
    links: [
      { to: '/research', label: '研究目录' },
      { to: '/about', label: '关于 · 方法论' },
      { to: '/contribute', label: '提交课题' },
    ],
  },
] as const
    ...
    <footer className="site-footer mt-24 px-4 py-14 text-[var(--muted)]">
      <div className="page-wrap">
        <div className="flex flex-col gap-10 sm:flex-row sm:justify-between">
          ...
          <div className="flex max-w-xs flex-col gap-3">
            ...
            <p className="m-0 text-sm leading-6 text-[var(--fg-soft)]">
              我们好奇的每一个问题，都值得被好好回答。可复现、可溯源、可同行评审的技术研究。
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-8 sm:flex sm:gap-16">
            ...
            <nav className="flex flex-col gap-2.5">
              <p className="kicker text-[0.62rem]">开源</p>
              <a
                href={SITE.repoUrl}
                target="_blank"
                rel="noreferrer"
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-[var(--border)] pt-6 text-xs sm:flex-row sm:items-center sm:justify-between">
          <p className="mono m-0 text-[var(--fg-soft)]">© 2026 42-research · MIT License</p>
          <div className="flex items-center gap-2.5">
            <span className="kicker text-[0.6rem]">built with</span>
            <a
